...
namespace OBAG.RazorPlusEngine
{
    public static class Helpers
    {
        ...
        public static object Eval(string Expression)
        {
            ...
            {
                return "ERROR! " + Expression + e.Message;
            }
        }
        ...
        // need Presentation Framework in references
        ...
        public static void CombineMultipleFilesIntoSingleFile(string[] inputFilePaths, string outputFilePath)
        {
            foreach (var inputFilePath in inputFilePaths)
            {
                if (File.Exists(inputFilePath))
                {
                    using (StreamWriter w = File.AppendText(outputFilePath))
                    {
                        ...
                        w.WriteLine(s + Environment.NewLine);
                    }
                }
            }
        }
