...
namespace OBAG.RazorPlusEngine
{
    public static class MeshExtensions
    {
        ...
        public static MeshGeometry3D ToVertexNormals(this MeshGeometry3D mesh, double length, double thickness)
        {
            ...
            for (int i = 0; i < mesh.Normals.Count; i++) vertex_normals[i] = mesh.Normals[i];
        ...
        private static void AddTriangleSegment(MeshGeometry3D mesh, MeshGeometry3D wireframe, Dictionary<int, int> already_drawn, int index1, int index2, double thickness)
        {
        ...
        public static void AddSegment(MeshGeometry3D mesh, Point3D point1, Point3D point2, double thickness, bool extend)
        {
        ...
        public static void AddSegment(MeshGeometry3D mesh, Point3D point1, Point3D point2, Vector3D up, double thickness, bool extend)
        {
        ...
        // Make an arrow.
        public static void AddArrow(this MeshGeometry3D mesh, Point3D point1, Point3D point2, Vector3D up, double barb_length)
        {
            // Make the shaft.
        ...
        public static void AddAxis(this MeshGeometry3D mesh, Point3D point1, Point3D point2, Vector3D up, double tic_diameter, double tic_separation)
        {
            // Make the shaft.
            AddSegment(mesh, point1, point2, 0.05, true);
        ...
        {
            MeshGeometry3D mesh = new MeshGeometry3D();
            mesh.AddArrow(new Point3D(0, 0, 0), new Point3D(0, 6, 0), new Vector3D(1, 0, 0), 0.5);
        ...
        {
            MeshGeometry3D mesh = new MeshGeometry3D();
            mesh.AddArrow(new Point3D(0, 0, 0), new Point3D(0, 0, 6), new Vector3D(0, 1, 0), 0.5);
        ...
        // Add a cage.
        public static void AddCage(this MeshGeometry3D mesh, float x, float y, float z, float dx, float dy, float dz, double thickness)
        {
            float xmin = x;
            float xmax = x + dx;
            float ymin = y;
